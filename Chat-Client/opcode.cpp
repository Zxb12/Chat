...
OpCodeHandler OpCodeTable[NB_OPCODES] =
{
    ...
    {"SMSG_INVALID_MESSAGE",                &FenPrincipale::handleError},
    {"SMSG_INVALID_NICK",                   &FenPrincipale::handleError},
    ...
    {"CMSG_LVL_MOD",                        &FenPrincipale::handleClientSide},
    {"SMSG_NOT_AUTHORIZED",                 &FenPrincipale::handleError},
    {"SMSG_USER_DOESNT_EXIST",              &FenPrincipale::handleError},
    {"SMSG_LVL_MOD_ERROR",                  &FenPrincipale::handleLevelMod},
    ...
    {"SMSG_LVL_MOD_OK",                     &FenPrincipale::handleLevelMod},
    {"SMSG_LVL_MOD_INVALID_LEVEL",          &FenPrincipale::handleLevelMod},
    {"SMSG_LVL_MOD_ACCT_DOESNT_EXIST",      &FenPrincipale::handleLevelMod},
    {"SMSG_LVL_MOD_LEVEL_TOO_HIGH",         &FenPrincipale::handleLevelMod},
    ...
    {"CMSG_UPDATE_CHANNEL",                 &FenPrincipale::handleClientSide},
    {"SMSG_CHANNEL",                        &FenPrincipale::handleChannel},
    {"CMSG_CHANNEL_JOIN",                   &FenPrincipale::handleClientSide},
    {"SMSG_CHANNEL_JOIN",                   &FenPrincipale::handleUserModification},
