...
enum OpCodeValues
{
    ...
    SMSG_LVL_MOD_OK                 = 0x25,
    SMSG_LVL_MOD_INVALID_LEVEL      = 0x26,
    SMSG_LVL_MOD_ACCT_DOESNT_EXIST  = 0x27,
    SMSG_LVL_MOD_LEVEL_TOO_HIGH     = 0x28,
    SMSG_LVL_MOD_NOT_YOURSELF       = 0x29,
    SMSG_LVL_CHANGED                = 0x2a,
